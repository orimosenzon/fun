...
const NPCS = {
  ...
  gaffer_gamgee: {
    ...
    race: "הוביט",
    title: "הגנן הזקן",
    portrait: "images/npcs/gaffer_gamgee.webp",
    disposition: "friendly",
  ...
  tom_bombadil_npc: {
    ...
    race: "לא ידוע",
    title: "הקדמון",
    portrait: "images/npcs/tom_bombadil.webp",
    disposition: "friendly",
  ...
  butterbur: {
    ...
    portrait: "images/npcs/butterbur.webp",
    disposition: "friendly",
  ...
  elrond: {
    ...
    race: "חצי-אלף",
    title: "אדון ריבנדל",
    portrait: "images/npcs/elrond.webp",
    disposition: "friendly",
  ...
  galadriel: {
    ...
    portrait: "images/npcs/galadriel.webp",
    disposition: "friendly",
  ...
  saruman: {
    ...
    race: "איסטאר (קוסם)",
    title: "סרומאן הלבן",
    portrait: "images/npcs/saruman.webp",
    disposition: "hostile",
  ...
  theoden: {
    ...
    race: "אדם",
    title: "מלך רוהאן",
    portrait: "images/npcs/theoden.webp",
    disposition: "friendly",
  ...
  eowyn: {
    ...
    race: "אדם",
    title: "גבירת רוהאן",
    portrait: "images/npcs/eowyn.webp",
    disposition: "friendly",
  ...
  faramir: {
    ...
    race: "אדם",
    title: "שר אית'יליאן",
    portrait: "images/npcs/faramir.webp",
    disposition: "friendly",
  ...
  gollum: {
    ...
    race: "הוביט (מושחת)",
    title: "סמיאגול",
    portrait: "images/npcs/gollum.webp",
    disposition: "guarded",
