...
#   4. gcloud run deploy math-form-checker --source .
#
...
if [[ -z "${MATH_FORM_CHECKER_ALLOWED_DOMAINS:-}" ]]; then
    echo "⚠️  MATH_FORM_CHECKER_ALLOWED_DOMAINS is empty — anyone with the form link can"
