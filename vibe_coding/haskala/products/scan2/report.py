"""report.py — report builders for math-checker (standalone HTML + Word).

Kept separate from core so the poller/CLI can generate reports without
pulling in the whole pipeline, and vice versa. No AI calls and no Flask here.
"""
