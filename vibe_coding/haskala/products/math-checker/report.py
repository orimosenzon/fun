"""report.py — בוני הדוחות של math-checker (HTML עצמאי + Word).

מופרד מ-core כדי שה-poller/CLI יוכלו לייצר דוחות בלי לגרור את כל ה-pipeline,
ולהפך. אין כאן קריאות AI ואין Flask.
"""
