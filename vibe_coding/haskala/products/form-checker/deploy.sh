...
gcloud run deploy "$SERVICE" \
    ...
    --set-env-vars="RESPONSES_SHEET_ID=${RESPONSES_SHEET_ID},FALLBACK_RESULTS_FOLDER_ID=${FALLBACK_RESULTS_FOLDER_ID:-},FORM_CHECKER_ALLOWED_DOMAINS=${FORM_CHECKER_ALLOWED_DOMAINS:-},MAX_FILES_PER_RESPONSE=${MAX_FILES_PER_RESPONSE:-10},MAX_PAGES_PER_RESPONSE=${MAX_PAGES_PER_RESPONSE:-20},MAX_ROWS_PER_RUN=${MAX_ROWS_PER_RUN:-5},AZURE_OPENAI_ENDPOINT=https://haskala-foundry-resource.openai.azure.com/openai/v1,AZURE_OPENAI_DEPLOYMENT=gpt-4.1-mini,LOG_LEVEL=${FORM_CHECKER_LOG_LEVEL:-INFO}"
