#!/usr/bin/env bash
# One-time Cloud Scheduler trigger wiring for demo-checker. Run once, AFTER the
...
JOB="demo-checker-poll"
SCHEDULE="${DEMO_CHECKER_SCHEDULE:-*/5 * * * *}"  # see the cost note above
